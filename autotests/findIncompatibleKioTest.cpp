...
void FindIncompatibleKioTest::find()
{
    ...
    out << "<div style='text-align:center; font-size:26px; font-variant:small-caps; margin-bottom:40px'>KIO "
           "Slaves Analyzing</div>"
        << endl;
    out << "<div style='font-style:italic'>Generated by <a "
           "href='https://commits.kde.org/ksystemlog?path=tests/"
           "findIncompatibleKioTest.cpp'>https://commits.kde.org/ksystemlog?path=tests/"
           "findIncompatibleKioTest.cpp</a></div>"
        << endl;
