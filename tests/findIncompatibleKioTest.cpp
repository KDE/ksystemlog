...
void FindIncompatibleKioTest::find() {
  ...
  parsingUrls.append(QUrl::fromLocalFile(kdebase + QLatin1String("/runtime/kioslave/settings/kio_settings.cc")));
  ...
  parsingUrls.append(QUrl::fromLocalFile(kdebase + QLatin1String("/runtime/kioslave/thumbnail/thumbnail.h")));
