...
static const QMap<ulong, QString> signalMap =
    { { 0,  QStringLiteral("SIG0") },
      { 1,  QStringLiteral("SIGHUP") },
      { 2,  QStringLiteral("SIGINT") },
      { 3,	QStringLiteral("SIGQUIT") },
      { 4,	QStringLiteral("SIGILL") },
      { 5,	QStringLiteral("SIGTRAP") },
      { 6,	QStringLiteral("SIGABRT") },
      { 7,	QStringLiteral("SIGBUS") },
      { 8,	QStringLiteral("SIGFPE") },
      { 9,	QStringLiteral("SIGKILL") },
      { 10,	QStringLiteral("SIGUSR1") },
      { 11,	QStringLiteral("SIGSEGV") },
      { 12,	QStringLiteral("SIGUSR2") },
      { 13,	QStringLiteral("SIGPIPE") },
      { 14,	QStringLiteral("SIGALRM") },
      { 15,	QStringLiteral("SIGTERM") },
      { 16,	QStringLiteral("SIGSTKFLT") },
      { 17,	QStringLiteral("SIGCHLD") },
      { 18,	QStringLiteral("SIGCONT") },
      { 19,	QStringLiteral("SIGSTOP") },
      { 20,	QStringLiteral("SIGTSTP") },
      { 21,	QStringLiteral("SIGTTIN") },
      { 22,	QStringLiteral("SIGTTOU") },
      { 23,	QStringLiteral("SIGURG") },
      { 24,	QStringLiteral("SIGXCPU") },
      { 25,	QStringLiteral("SIGXFSZ") },
      { 26,	QStringLiteral("SIGVTALRM") },
      { 27,	QStringLiteral("SIGPROF") },
      { 28,	QStringLiteral("SIGWINCH") },
      { 29,	QStringLiteral("SIGIO") },
      { 30,	QStringLiteral("IGPWR") },
      { 31,	QStringLiteral("SIGSYS") } };

static const QMap<ulong, QString> cloneFlagMap =
    { { 0x00000100,	QStringLiteral("CLONE_VM") },
...
static const QMap<ulong, QString> clockMap =
    { { 0,  QStringLiteral("CLOCK_REALTIME") },
...
static const QMap<ulong, QString> personMap =
    { { 0x0000, QStringLiteral("PER_LINUX") },
...
static const QMap<ulong, QString> ptraceMap =
    { { 0,	    QStringLiteral("PTRACE_TRACEME") },
...
static const QMap<ulong, QString> prctloptMap =
    { { 1,  QStringLiteral("PR_SET_PDEATHSIG") },
...
static const QMap<ulong, QString> rlimitMap =
    { { 0,  QStringLiteral("RLIMIT_CPU") },
...
static const QMap<ulong, QString> famMap =
    { { AF_LOCAL,      QStringLiteral("local") },
...
static const QMap<ulong, QString> sockMap =
    { { SYS_SOCKET,		 QStringLiteral("socket") },
...
static const QMap<ulong, QString> ipcMap =
    { { SEMOP,      QStringLiteral("semop") },
...
static const QMap<ulong, QString> bpfMap =
    { { 0,  QStringLiteral("BPF_MAP_CREATE") },
      { 1,  QStringLiteral("BPF_MAP_LOOKUP_ELEM") },
      { 2,  QStringLiteral("BPF_MAP_UPDATE_ELEM") },
      { 3,  QStringLiteral("BPF_MAP_DELETE_ELEM") },
      { 4,  QStringLiteral("BPF_MAP_GET_NEXT_KEY") },
      { 5,  QStringLiteral("BPF_PROG_LOAD") },
      { 6,  QStringLiteral("BPF_OBJ_PIN") },
      { 7,  QStringLiteral("BPF_OBJ_GET") },
      { 8,  QStringLiteral("BPF_PROG_ATTACH") },
      { 9,  QStringLiteral("BPF_PROG_DETACH") },
      { 10, QStringLiteral("BPF_PROG_TEST_RUN") },
      { 11, QStringLiteral("BPF_PROG_GET_NEXT_ID") },
      { 12, QStringLiteral("BPF_MAP_GET_NEXT_ID") },
      { 13, QStringLiteral("BPF_PROG_GET_FD_BY_ID") },
      { 14, QStringLiteral("BPF_MAP_GET_FD_BY_ID") },
      { 15, QStringLiteral("BPF_OBJ_GET_INFO_BY_FD") },
      { 16, QStringLiteral("BPF_PROG_QUERY") },
      { 17, QStringLiteral("BPF_RAW_TRACEPOINT_OPEN") },
      { 18, QStringLiteral("BPF_BTF_LOAD") },
      { 19, QStringLiteral("BPF_BTF_GET_FD_BY_ID") },
      { 20, QStringLiteral("BPF_TASK_FD_QUERY") },
      { 21, QStringLiteral("BPF_MAP_LOOKUP_AND_DELETE_ELEM") },
      { 22, QStringLiteral("BPF_MAP_FREEZE") },
      { 23, QStringLiteral("BPF_BTF_GET_NEXT_ID") } };

static const QMap<ulong, QString> fcntlcmdMap =
    { { 0,	  QStringLiteral("F_DUPFD") },
...
static const QMap<ulong, QString> socklevelMap =
    { { 0,   QStringLiteral("SOL_IP") },
      { 6,   QStringLiteral("SOL_TCP") },
      { 17,  QStringLiteral("SOL_UDP") },
      { 41,  QStringLiteral("SOL_IPV6") },
      { 58,  QStringLiteral("SOL_ICMPV6") },
      { 132, QStringLiteral("SOL_SCTP") },
      { 136, QStringLiteral("SOL_UDPLITE") },
      { 255, QStringLiteral("SOL_RAW") },
      { 256, QStringLiteral("SOL_IPX") },
      { 257, QStringLiteral("SOL_AX25") },
      { 258, QStringLiteral("SOL_ATALK") },
      { 259, QStringLiteral("SOL_NETROM") },
      { 260, QStringLiteral("SOL_ROSE") },
      { 261, QStringLiteral("SOL_DECNET") },
      { 263, QStringLiteral("SOL_PACKET") },
      { 264, QStringLiteral("SOL_ATM") },
      { 265, QStringLiteral("SOL_AAL") },
      { 266, QStringLiteral("SOL_IRDA") },
      { 267, QStringLiteral("SOL_NETBEUI") },
      { 268, QStringLiteral("SOL_LLC") },
      { 269, QStringLiteral("SOL_DCCP") },
      { 270, QStringLiteral("SOL_NETLINK") },
      { 271, QStringLiteral("SOL_TIPC") },
      { 272, QStringLiteral("SOL_RXRPC") },
      { 273, QStringLiteral("SOL_PPPOL2TP") },
      { 274, QStringLiteral("SOL_BLUETOOTH") },
      { 275, QStringLiteral("SOL_PNPIPE") },
      { 276, QStringLiteral("SOL_RDS") },
      { 277, QStringLiteral("SOL_IUCV") },
      { 278, QStringLiteral("SOL_CAIF") },
      { 279, QStringLiteral("SOL_ALG") },
      { 280, QStringLiteral("SOL_NFC") },
      { 281, QStringLiteral("SOL_KCM") },
      { 282, QStringLiteral("SOL_TLS") },
      { 283, QStringLiteral("SOL_XDP") } };

static const QMap<ulong, QString> socktypeMap =
    { { 1,  QStringLiteral("SOCK_STREAM") },
...
static const QMap<ulong, QString> schedMap =
    { {0, QStringLiteral("SCHED_OTHER") },
...
static const QMap<ulong, QString> openflagMap =
    { { 0x0,	    QStringLiteral("O_RDONLY") },
...
static const QMap<ulong, QString> accessMap =
    { { 0x1U, QStringLiteral("X_OK"	) },
      { 0x2U, QStringLiteral("W_OK"	) },
      { 0x4U, QStringLiteral("R_OK"	) } };

static const QMap<ulong, QString> epollctlMap =
    { { 1, QStringLiteral("EPOLL_CTL_ADD") },
      { 2, QStringLiteral("EPOLL_CTL_DEL") },
      { 3, QStringLiteral("EPOLL_CTL_MOD") } };

static const QMap<ulong, QString> capMap =
    { { 0,  QStringLiteral("chown") },
...
static const QMap<ulong, QString> umountMap =
    { { 0x00000001, QStringLiteral("MNT_FORCE") },
...
static const QMap<ulong, QString> ioctlreqMap =
    { { 0x4B3A,     QStringLiteral("KDSETMODE") },
...
static const QMap<ulong, QString> ipoptnameMap =
    { { 1,  QStringLiteral("IP_TOS") },
...
static const QMap<ulong, QString> sockoptnameMap =
    { { 1,   QStringLiteral("SO_DEBUG") },
...
static const QMap<ulong, QString> tcpoptnameMap =
    { { 1,  QStringLiteral("TCP_NODELAY") },
...
static const QMap<ulong, QString> ip6optnameMap =
    { { 1,  QStringLiteral("IPV6_ADDRFORM") },
...
static const QMap<ulong, QString> pktoptnameMap =
    { { 1,  QStringLiteral("PACKET_ADD_MEMBERSHIP") },
      { 2,  QStringLiteral("PACKET_DROP_MEMBERSHIP") },
      { 3,  QStringLiteral("PACKET_RECV_OUTPUT") },
      { 5,  QStringLiteral("PACKET_RX_RING") },
      { 6,  QStringLiteral("PACKET_STATISTICS") },
      { 7,  QStringLiteral("PACKET_COPY_THRESH") },
      { 8,  QStringLiteral("PACKET_AUXDATA") },
      { 9,  QStringLiteral("PACKET_ORIGDEV") },
      { 10, QStringLiteral("PACKET_VERSION") },
      { 11, QStringLiteral("PACKET_HDRLEN") },
      { 12, QStringLiteral("PACKET_RESERVE") },
      { 13, QStringLiteral("PACKET_TX_RING") },
      { 14, QStringLiteral("PACKET_LOSS") },
      { 15, QStringLiteral("PACKET_VNET_HDR") },
      { 16, QStringLiteral("PACKET_TX_TIMESTAMP") },
      { 17, QStringLiteral("PACKET_TIMESTAMP") },
      { 18, QStringLiteral("PACKET_FANOUT") },
      { 19, QStringLiteral("PACKET_TX_HAS_OFF") },
      { 20, QStringLiteral("PACKET_QDISC_BYPASS") },
      { 21, QStringLiteral("PACKET_ROLLOVER_STATS") },
      { 22, QStringLiteral("PACKET_FANOUT_DATA") },
      { 23, QStringLiteral("PACKET_IGNORE_OUTGOING") } };

static const QMap<ulong, QString> recvMap =
    { { 0x00000001, QStringLiteral("MSG_OOB") },
      { 0x00000002, QStringLiteral("MSG_PEEK") },
      { 0x00000004, QStringLiteral("MSG_DONTROUTE") },
      { 0x00000008, QStringLiteral("MSG_CTRUNC") },
      { 0x00000010, QStringLiteral("MSG_PROXY") },
      { 0x00000020, QStringLiteral("MSG_TRUNC") },
      { 0x00000040, QStringLiteral("MSG_DONTWAIT") },
      { 0x00000080, QStringLiteral("MSG_EOR") },
      { 0x00000100, QStringLiteral("MSG_WAITALL") },
      { 0x00000200, QStringLiteral("MSG_FIN") },
      { 0x00000400, QStringLiteral("MSG_SYN") },
      { 0x00000800, QStringLiteral("MSG_CONFIRM") },
      { 0x00001000, QStringLiteral("MSG_RST") },
      { 0x00002000, QStringLiteral("MSG_ERRQUEUE") },
      { 0x00004000, QStringLiteral("MSG_NOSIGNAL") },
      { 0x00008000, QStringLiteral("MSG_MORE") },
      { 0x00010000, QStringLiteral("MSG_WAITFORONE") },
      { 0x00020000, QStringLiteral("MSG_SENDPAGE_NOTLAST") },
      { 0x00040000, QStringLiteral("MSG_BATCH") },
      { 0x20000000, QStringLiteral("MSG_FASTOPEN") },
      { 0x40000000, QStringLiteral("MSG_CMSG_CLOEXEC") },
      { 0x80000000, QStringLiteral("MSG_CMSG_COMPAT") } };

static const QMap<ulong, QString> shmmodeMap =
    { { 00001000, QStringLiteral("SHM_DEST") },
      { 00002000, QStringLiteral("SHM_LOCKED") },
      { 00004000, QStringLiteral("SHM_HUGETLB") },
      { 00010000, QStringLiteral("SHM_NORESERVE") } };

static const QMap<ulong, QString> ipccmdMap =
    { { 00001000, QStringLiteral("IPC_CREAT") },
      { 00002000, QStringLiteral("IPC_EXCL") },
      { 00004000, QStringLiteral("IPC_NOWAIT") } };

static const QMap<ulong, QString> protMap =
    { { 1, QStringLiteral("PROT_READ") },
      { 2, QStringLiteral("PROT_WRITE") },
      { 4, QStringLiteral("PROT_EXEC") },
      { 8, QStringLiteral("PROT_SEM") } };

static const QMap<ulong, QString> seekMap =
    { { 0, QStringLiteral("SEEK_SET") },
      { 1, QStringLiteral("SEEK_CUR") },
      { 2, QStringLiteral("SEEK_END") },
      { 3, QStringLiteral("SEEK_DATA") },
      { 4, QStringLiteral("SEEK_HOLE") } };

static const QMap<ulong, QString> mmapMap =
    { { 0x0000001, QStringLiteral("MAP_SHARED") },
...
static const QMap<ulong, QString> mountMap =
    { { MS_RDONLY,      QStringLiteral("MS_RDONLY") },
