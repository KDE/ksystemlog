...
NetbiosLogMode::NetbiosLogMode(SambaConfiguration* sambaConfiguration, SambaConfigurationWidget* sambaConfigurationWidget, SambaItemBuilder* itemBuilder) : 
	LogMode(NETBIOS_LOG_MODE_ID, i18n("Netbios Log"), NETBIOS_MODE_ICON) {
	...
	d->action->setWhatsThis(i18n("<qt>Displays the Netbios log in the current tab. Netbios is the file sharing protocol developed by Microsoft.</qt>"));
